        ...
        <div className='container py-3'>
          <div className="d-flex justify-content-between align-items-center w-100">
            ...
            <div className="d-flex justify-content-end">
              ...
              <img src={assets.search_icon} alt="Search" className='mx-2 my-md-1 pb-lg-1' height={25} width={25} onClick={searchHandleShow} />
              <Link to={'/wishlist'} className="position-relative d-none d-md-inline d-lg-inline">
                <img src={assets.like_icon} alt="Like" height={20} width={20} className="mx-2 my-1" />
              ...
              <div className="position-relative">
                <img src={assets.bag_icon} alt="Bag" className='mx-2' height={28} width={28} onClick={carthandleShow} />
